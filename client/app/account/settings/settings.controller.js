      ...
      if (form.$valid) {
        this.Auth.changePassword(this.user.oldPassword, this.user.newPassword).then(function () {
          ...
          if (err.message === 'User validation failed') {
            _this.errors.other = 'New password is shorter than the minimum allowed length (6)';
          } else {
...
angular.module('meanonlineshopApp').controller('SettingsController', SettingsController);
